...
public class CustomerServices {
	...
	public void createCustomer() throws ServletException, IOException {
		...
		if(existCustomer != null) {
			String message = "Can't create customer : the email" +email+ "is already registered by another customer";
	...
	public void registerCustomer() throws ServletException, IOException {
		...
		String message = "";
		if(existCustomer != null) {
			 message = "Can't register customer : the email" +email+ "is already registered by another customer";
			...
			message = "You've registered successfully! ThankYou";
